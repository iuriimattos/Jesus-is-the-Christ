...
F1::
  ...
  action(str, to) {
    translated := GoogleTranslate(str, "en", to)
  ...
  Loop {
    ...
    action(JESUS_MEU_SALVADOR_E_SENHOR, "en")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "es")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "ar")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "uk")
