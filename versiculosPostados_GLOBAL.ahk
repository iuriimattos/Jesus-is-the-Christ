...
F1::
  ...
  Loop {
    ...
    action(JESUS_MEU_SALVADOR_E_SENHOR, "zh")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "hi")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "es")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "fr")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "ar")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "bn")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "pt")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "id")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "ru")
    action(JESUS_MEU_SALVADOR_E_SENHOR, "ja")
